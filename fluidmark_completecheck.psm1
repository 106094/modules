...
exit
 ...
 $picfile1=(Get-ChildItem $picpath |Where-object{$_.name -match ".jpg" -and $_.name -match $action -and $_.name -match "step$($tcstep)"}|sort lastwritetime |select -Last 1).FullName
