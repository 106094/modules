function SPECviewperf_CompleteCheck ([string]$para1) {
   ...
   $mgntrbjsb="C:\SPEC\SPECgpc\SPECviewperf13\vp13bench\gwpgRunBenchmark_0.js"
    ...
    if($benchtype -eq "SPECviewperf2020"){
     ...
     $resultfd=Get-ChildItem -Path C:\SPEC\SPECgpc\SPECviewperf2020\results_*  -Directory|Where-object{$_.CreationTime -gt $lastlogtime}
    ...
    exit
     ...
     #check 1 results
     $resultfd1=Get-ChildItem -Path C:\SPEC\SPECgpc\SPECviewperf2020\results_*  -Directory|Where-object{$_.CreationTime -gt $lastlogtime}|Sort-Object creationtime|Select-Object -First 1
     $csvraw=get-content -path ($resultfd1.fullname)
   ...
   &$action2020 -para1 "$action2020" -para2 $retestitempara -para4 "nonlog"
   }
   ...
   $mgntrbjsb="C:\SPEC\SPECgpc\SPECviewperf2020\vpbench\gwpgRunBenchmark_0.js"
    ...
    Copy-Item -Path $resultfd2.FullName -Destination $picpath -Recurse -Force
