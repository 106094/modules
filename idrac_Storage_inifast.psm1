function idrac_Storage_inifast ([string]$para1,[string]$para2){
...
try{
 ...
 foreach ($option in $optionElements) {
    ...
    if ($option.GetAttribute("label") -match "Fast") {
...
#$switch=$driver.SwitchTo().Window(($driver.WindowHandles)[-1])
 start-sleep -s 10
  ...
  #region screenshot
   $timenow=get-date -format "yyMMdd_HHmmss"
   $savepic=$picpath+"$($timenow)_step$($tcstep)_$($vdname)_fastini.jpg"
   $screenshot = $driver.GetScreenshot()
   $screenshot.SaveAsFile( $savepic, [OpenQA.Selenium.ScreenshotImageFormat]::Jpeg)
#endregion
 ...
 $okbut.Click()
  ...
  #region screenshot
   $timenow=get-date -format "yyMMdd_HHmmss"
   $savepic=$picpath+"$($timenow)_step$($tcstep)_$($vdname)_fastini_OK.jpg"
   $screenshot = $driver.GetScreenshot()
   $screenshot.SaveAsFile( $savepic, [OpenQA.Selenium.ScreenshotImageFormat]::Jpeg)
#endregion
...
#$switch=$driver.SwitchTo().Window(($driver.WindowHandles)[-1])
 ...
 $fastapply.Click()
  ...
  #region screenshot
   $timenow=get-date -format "yyMMdd_HHmmss"
   $savepic=$picpath+"$($timenow)_step$($tcstep)_$($vdname)_fastini_Apply.jpg"
   $screenshot = $driver.GetScreenshot()
   $screenshot.SaveAsFile( $savepic, [OpenQA.Selenium.ScreenshotImageFormat]::Jpeg)
#endregion
...
#region screenshot
   $timenow=get-date -format "yyMMdd_HHmmss"
   $savepic=$picpath+"$($timenow)_step$($tcstep)_$($vdname)_fastini_JobQueue.jpg"
   $screenshot = $driver.GetScreenshot()
   $screenshot.SaveAsFile( $savepic, [OpenQA.Selenium.ScreenshotImageFormat]::Jpeg)
#endregion
...
#region screenshot
   $timenow=get-date -format "yyMMdd_HHmmss"
   $savepic=$picpath+"$($timenow)_step$($tcstep)_$($vdname)_fastini_done.jpg"
   $screenshot = $driver.GetScreenshot()
   $screenshot.SaveAsFile( $savepic, [OpenQA.Selenium.ScreenshotImageFormat]::Jpeg)
...
Export-ModuleMember -Function idrac_Storage_inifast